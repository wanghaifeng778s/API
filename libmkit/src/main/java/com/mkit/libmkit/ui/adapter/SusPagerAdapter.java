...
public abstract class SusPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public SusPagerAdapter(FragmentManager fm, Context context, List<String> tabList, List<Fragment> fragmentList) {
        super(fm);
    ...
    public SusPagerAdapter(FragmentManager fm) {
        super(fm);
